...
import { FiSearch, FiUpload, FiMenu, FiX, FiSettings, FiFileText, FiHelpCircle, FiCode, FiLogOut, FiUser, FiHome, FiGrid, FiStar, FiBookOpen } from 'react-icons/fi';
  ...
  return (
    <>
      ...
      <div className={`slide-menu ${menuOpen ? 'open' : ''}`}>
        ...
        <div className="menu-content">
          ...
          <div className="menu-links">
            ...
            <Link to="/featured" onClick={() => setMenuOpen(false)} className="menu-item featured">
              <FiStar /> Featured Apps
            </Link>
            <Link to="/categories" onClick={() => setMenuOpen(false)} className="menu-item categories">
              <FiGrid /> Categories
            </Link>
          </div>
      ...
      <style jsx>{`
        ...
        .menu-item.home { color: #6366f1; }
        .menu-item.upload { color: #8b5cf6; }
        .menu-item.featured { color: #fbbf24; }
        .menu-item.categories { color: #06b6d4; }
